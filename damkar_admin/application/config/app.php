...
$config["path_docs"]="docs/brwa/";
$config["path_img"]="docs/brwa/img/";
$config["path_img_ori"]="docs/brwa/img/ori/";
$config["path_img_resize"]="docs/brwa/img/resize/";
$config["path_img_thumb"]="docs/brwa/img/thumb/";
