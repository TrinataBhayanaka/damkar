...
*/
function bc($code="12345678901234",$type="C128A",$width=250,$height=80,$xres=1) {
  ...
  if (!isset($style))  $style   = BCS_STRETCH_TEXT | BCS_DRAW_TEXT | BCS_ALIGN_CENTER | BCS_IMAGE_PNG;
