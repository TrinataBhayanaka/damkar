	    ...
	    <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" id="id_potensi_hayati" name="id_potensi_hayati" class="form-control input-xs required"  />
                </div>
            </div>
            <div class="">
                <div class="row">
                    <div class="col-md-8">
	                    <label>Nama Potensi Hayati *</label>
	                    <input type="text" id="nama_potensi_hayati" name="nama_potensi_hayati" class="form-control input-xs required"  />
	                </div>
                </div>
            </div>
        </div>
