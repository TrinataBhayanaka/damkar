...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>Potensi Hayati <small>List</small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
...
<table class="table table-hover small-font">
	<thead>
         ...
         <tr>
          	<th width="80"></th>          		
          	<th width="20">No</th> 
		    <th width="200">ID Potensi Hayati</th>
		    <th>Nama Potensi Hayati</th>
		    </tr>  
    </thead>
    <tbody>
    	<?php if(cek_array($arrData)):?>
        	<?php foreach($arrData as $x=>$val):?>
            	...
            	<tr >
                	...
                	<td valign="top"><?php echo $val["id_potensi_hayati"]?></td>
                	<td valign="top"><a href="<?=$this->module?>edit/<?=$id?>"><?php echo $val["nama_potensi_hayati"]?></a></td>
                </tr>
            <?php endforeach;?>
		<?php endif;?>
    </tbody>
