    ...
    <div class="col-sm-12 col-lg-12">
        ...
        <!-- start: breadcrumbs -->
         <ul class="breadcrumb">
            ...
            <li><a href="<?=$this->folder?>/potensi_hayati">Master Data</a> <span class="divider"></span></li>
    ...
    <div class="row">
	    <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8">
                    <label>ID Potensi Hayati</label>
                    <input type="text" id="id_potensi_hayati" name="id_potensi_hayati" class="form-control input-xs required" value="<?=$data['id_potensi_hayati'];?>" />
                </div>
                  <div class="col-md-8">
                  
        
                    <label>ID Potensi Hayati</label>
                    <input type="text" id="id_potensi_hayati" name="nama_potensi_hayati" class="form-control input-xs required" value="<?=$data['nama_potensi_hayati'];?>" />
                </div> 
                  </div>
