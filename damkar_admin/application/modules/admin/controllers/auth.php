...
class Auth extends CI_Controller {
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->_render_page('admin/auth/forgot_password', $this->data,true);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				//render
				$this->_render_page('admin/auth/reset_password', $this->data,true);
			}
			else
			{
	...
	function create_user()
	{
		...
		else
		{
			...
			$this->_render_page('auth/create_user', $this->data,true);
		}
	}
	...
	function edit_user($id)
	{
		...
		$this->_render_page('auth/edit_user', $this->data,true);
	}
	...
	function edit_group($id)
	{
		...
		if (isset($_POST) && !empty($_POST))
		{
			if ($this->form_validation->run() === TRUE)
			{
				...
				redirect("admin/auth/list_group/");
			}
		}
