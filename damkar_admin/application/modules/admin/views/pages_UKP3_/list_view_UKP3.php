    ...
    <div class="col-sm-12 col-lg-12">
        ...
        <!-- start: breadcrumbs -->
         <ul class="breadcrumb">
            ...
            <li class="active"><?=$this->module_title2?></li>
         </ul>
        <!-- end: breadcrumbs -->
   </div><!-- cols -->
</div> <!-- row -->
		...
		<div class="col-md-12">
			<div class="pull-left">
				<ul class="tab-bar grey-tab">
					...
					<li>
						<a href="<?php echo $this->module?>add_ukp3">
							<span class="block text-center">
								<i class="icon-plus"></i> 
							</span>
...
<div id="tabs-0">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover small-font"">		
        <thead>
        <tr>
        <th width="80">&nbsp;</th>
        <th width="20">No.</th>
        ...
        <th class="forder" width="200" rel="title">Wilayah</th>
  ...
  <? if (is_array($arrDB)) { foreach($arrDB as $k=>$v) {
		...
		$url_edit = $module."edit_ukp3/".$v['idx'];
		$url_delete = $module."delete_ukp3/".$v['idx'];
   ...
   ?>
            	<tr>
                    ...
                    <td rel="date_col" width="150"><a href="<?=$url_edit;?>"><?=$v['wilayah'];?></a></td>
                    <td><?=$v['nama'];?></td>
