...
<div class="col-md-12 col-lg-12">
    ...
    <div class="row-fluid">
		...
		<input type="hidden" name="act" id="act" value="update"/>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									...
									?>
									<?php
										// $arrPropinsi1=array(""=>"--Pilih Propinsi--")+$dg;
										// $data_propinsi=$data["id_propinsi"];
									?>
									<div class="form-group">
							...
							<div class="form-group">
								<div>
									...
									<div style="padding-left:20px;" class="checkbox">
										...
										<span class="help-block" style="display:inline;color:red;">(Klik Pada peta untuk menentukan Langitude / Longitude)</span>
									  </div>
								</div>
							</div>
							<div class="row">
				  ...
				  <div class="row">
						<div class="col-md-9">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
									<label>Batas Wilayah</label><i class="fa fa-question-circle frmtip" title="<?=$tooltip['4_b']?>"></i>
									...
									<tr>
										...
										<td><textarea name="batas_barat" class="form-control" rows="2"><?=$data["batas_barat"]; ?></textarea></td>
									</tr>
									<tr>
										<td style="width:30%">Batas Selatan</td>
										<!-- <td><?php echo form_input('batas_selatan',false,'class="form-control"');?></td>  -->
										<td><textarea name="batas_selatan" class="form-control" rows="2"><?=$data["batas_selatan"]; ?></textarea></td>
									</tr>
									<tr>
										<td style="width:30%">Batas Timur</td>
										<!-- <td><?php echo form_input('batas_timur',false,'class="form-control"');?></td> -->
										<td><textarea name="batas_timur" class="form-control" rows="2"><?=$data["batas_timur"]; ?></textarea></td>
									</tr>
									<tr>
										<td style="width:30%">Batas Utara</td>
										<!-- <td><?php echo form_input('batas_utara',false,'class="form-control"');?></td> -->
										<td><textarea name="batas_utara" class="form-control" rows="2"><?=$data["batas_utara"]; ?></textarea></td>
									</tr>
									</tbody>
									</table>
									</div>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="wa_hak_pembagian_ruang" class="form-control" rows="3"><?=$data["wa_hak_pembagian_ruang"]?></textarea>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="sistem_penguasaan" class="form-control " rows="3"><?=$data["sistem_penguasaan"]?></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="mekanisme_pengambilan_keputusan" class="form-control required" rows="3"><?=$data["mekanisme_pengambilan_keputusan"]?></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="aturan_adat" class="form-control " rows="3"><?=$data["aturan_adat"]?></textarea>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>Jenis Ekosistem</label><i class="fa fa-question-circle frmtip" title="<?=$tooltip['10_a']?>"></i>
                                        <?php 	
                                            $input2 = $data["jenis_ekosistem"];
                                            $arrDebe_ = explode(',', $input2 );
                                            //$kfisik=m_lookup("wa_kondisi_fisik","idx","kondisi_fisik",""," order by order_num asc "); 												
                                            $arrLookupGroup=m_lookup("wa_jenis_ekosistem","id_jenis_ekosistem","jenis_ekosistem",""," order by order_num asc "); 
                                            foreach($arrDebe_ as $ke => $va){
                                                $d[] = $va;
                                            }
                                        ...
                                        ?>
                                            <div class="radio" style="padding-left:0px;">
                                                <label>
                                                <input <?=(in_array($k, $d) ? 'checked' : '');?> name="list_jenis_ekosistem[]" type="checkbox" value="<?=$k;?>">
                                                <?=$v;?>
                                                </label>
                                            </div>
                                        <? }?>
							...
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    <?php foreach($arrLookupGroup as $id_potensi => $nama_potensi):?>
                                    	<tr><td style="width: 30%"><?php echo $nama_potensi?><input type="hidden" class="form-control" value="<?php echo $id_potensi;?>" name="id_potensi[]"><input type="hidden" class="form-control" value="<?php echo $nama_potensi?>" name="potensi[]"></td>
                                    	
                                    	<!-- <td><input type="text" class="form-control" value="<?php echo $potensi[$id_potensi]["keterangan"]?>" name="potensi_val[]"></td> -->
                                    	<td><textarea name="potensi_val[]" class="form-control" rows="2"><?php echo $potensi[$id_potensi]["keterangan"]?></textarea></td></tr>
									<?php endforeach;?>
                                    <?php if(cek_array($potensi_lain)):?>
                                    	<?php foreach($potensi_lain as $val):?>
                                        	<tr><td><input type="text" class="form-control" value="<?php echo $val["nama_potensi_hayati"]?>" name="potensi_lain[]"></td>
                                        	<td width="5"><a class="del-row-bw pull-right" href="#"><i class="fa fa-times-circle"></i></a></td>
                                        	<td><input type="text" class="form-control" value="<?php echo $val["keterangan"]?>" name="potensi_lain_val[]"></td></tr>
										<?php endforeach;?>
									<?php endif;?>
            ...
            <div class="box-body">
             <h5 class="heading">Upload Document <span style="color:#FF0000; font-size:11px; font-weight:500">File Size Maksimal [ 3250KB ]</span></h5>
             <div class="form-group">
                <div class="col-md-12"  >
                    <?php
        ...
        <td><a href="" class='upload_file_remove red'><i class="icon-remove"></i> </a></td>
            ...
            <div class="clearfix"></div>
                        ...
                        <div class="col-md-6">
                        	<div class="box box-success" >
            <div class="box-body">            
            <h5 class="heading">Upload Peta  <span style="color:#FF0000; font-size:11px; font-weight:500">File Size Maksimal [ 3250KB ]</span></h5>
        ...
        <label style='height:auto;'><?=$filep["file_name"]?></label></td><td><a href="" class='peta_file_remove red'><i class="icon-remove"></i> </a></td></tr>
            ...
            <div class="clearfix"></div>
                    ...
                    <div class="row">
                                ...
                                <span style="color:#FF0000; font-size:11px; font-weight:500">( File Size Maksimal [ 3250KB ] )</span><br />
