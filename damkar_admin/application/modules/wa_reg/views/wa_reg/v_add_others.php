		...
		<input type="hidden" name="act" id="act" value="create"/>
			<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<?php echo form_input('pos_x',false,'id="koordinat_bujur" readonly class="form-control required"');?>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									<label>Longitude</label>
									<?php echo form_input('pos_y',false,'id="koordinat_lintang" readonly class="form-control required"');?>
									</div>
								</div>
							</div>
						</div>
				...
				<!--Kependudukan -->
					...
					<div class="row">
						<div class="col-md-12">
							<h3>Hak atas tanah dan pengelolaan Wilayah <i class="fa fa-question-circle frmtip" title="<?=$tooltip['7']?>"></i></h3>
						</div>
					</div>
				  <div class="row">
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
									<label>Pembagian ruang menurut aturan adat</label><i class="fa fa-question-circle frmtip" title="<?=$tooltip['7_a']?>"></i>
									<textarea name="wa_hak_pembagian_ruang" class="form-control" rows="3"></textarea>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="sistem_penguasaan" class="form-control " rows="3"></textarea>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<label>Struktur Lembaga Adat</label><i class="fa fa-question-circle frmtip" title="<?=$tooltip['8_b']?>"></i>
									 <textarea name="struktur" class="form-control required" rows="4"></textarea>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="mekanisme_pengambilan_keputusan" class="form-control required" rows="3"></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="aturan_adat" class="form-control " rows="3"></textarea>
									</div>
								</div>
							</div>
							<!-- <div class="row">
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<textarea name="contoh_keputusan" class="form-control required" rows="7"></textarea>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    <?php foreach($arrLookupGroup as $id_potensi => $nama_potensi):?>
                                    	<tr><td style="width: 23%"><?php echo $nama_potensi?><input type="hidden" class="form-control" value="<?php echo $id_potensi;?>" name="id_potensi[]">
                                    	<input type="hidden" class="form-control" value="<?php echo $nama_potensi?>" name="potensi[]"></td>
                                    	<!-- <td><input type="text" class="form-control" value="<?php echo $potensi[$id_potensi]["keterangan"]?>" name="potensi_val[]"></td> -->
                                    	<td><textarea name="potensi_val[]" class="form-control" rows="2"><?php echo $potensi[$id_potensi]["keterangan"]?></textarea></td>
                                    	</tr>
									<?php endforeach;?>
                                    </tbody>
                                    </table>
				  ...
				  <div class="row">
						<div class="col-md-12">
							<!--Confirm-->
								<div class="row">
									<div class="col-md-12">
										<h3>Apakah Registrasi Wilayah Adat sudah di Musyawarahkan? <i class="fa fa-question-circle frmtip" title="<?=$tooltip['12']?>"></i></h3>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
