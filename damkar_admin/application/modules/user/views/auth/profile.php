...
<!--<div class="row-fluid">
    <div class="span12">
        <ul class="nav nav-tabs" style="margin-top:30px;border-bottom:1px solid #aaa">
            <li class="active"><a href="user/profile/<?=$user->id;?>">Profile</a></li>
...
<div class="tab-contents" style="padding-top:40px">
<div id="tab-edit" class="tab-pane active">    
	<div class="row-fluid">
	    <div class="span12">
            <div class="row-fluid">
                <div class="span7">
                    <h3 class="sub span11" style="border-bottom:2px solid #aaa">Identitas (<?=$user->email?>)</h3>
                    	<div class="row-fluid">
                            <div class="span11">
                        ...
                        <div class="row-fluid">
                            <div class="span11">
                                ...
                                <textarea name="alamat" class="span12 required" rows="3"><?=$user->alamat?></textarea>
                            </div>
                        </div>
                        <div class="row-fluid">
                            <div class="span11">
                        ...
                        <?php							
							if ($user->image) {
								...
								$image_canvas = '<canvas id="myCanvas" width="200" height="150" style="background-image:url(assets/image/members/'.$user->image.');background-size: 100%;"></canvas>';
                        ...
                        <div class="row-fluid">
                            <div class="span11">
                                ...
                                <div id="imgcontainer">
                                    ...
                                    <div id="btn-change" class="img-btn-change"><span><i class="icon-pencil"></i> &nbsp;Ganti</span></div>
                                </div>
                ...
                <div class="span5">
                	<h3 class="sub span12" style="border-bottom:2px solid #aaa">Ganti Password</h3>
                    <div class="row-fluid">
                        <div class="span12">
                            <?php echo lang('create_user_password_label', 'password');?>
                            <?php echo form_input($password,false,'class="span12"');?>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span12">
                            <?php echo lang('create_user_password_confirm_label', 'password_confirm');?>
                            <?php echo form_input($password_confirm,false,'class="span12"');?>
                        </div>
                    </div>
                </div>
            </div>
