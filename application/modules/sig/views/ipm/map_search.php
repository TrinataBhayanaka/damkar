...
if (is_array($list)) {
	?>
        ...
        <div style="margin-bottom:5px">
         ...
         ?>
            <div style="width:170px; display:inline-block" title="<?php echo $alt;?>"><?php echo $iv['kategori'];?></div> <span style="margin-left:5px;border-bottom:1px dotted #999">: <strong><?php echo number_format($v[$iv['colom_nilai']],0,0,".");?></strong>  <?php echo $iv['satuan'];?></span><br />
         <?php
         }}}
         ?>
         </blockquote>
