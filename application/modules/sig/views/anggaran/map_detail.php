...
<div style="padding:0 15px 0 15px; margin-top:-10px">
    <div class="row-fluid">
        <div class="span7">
            <div class="row-fluid">
                <div class="span12">
                    <h3>&nbsp;Data Sebaran Anggaran Wilayah<small class="pull-right" style="color:grey; line-height:50px"> <i class="icon-tag"></i> Indikator: <strong><?php echo $indikator[$indikator_aktif]['kategori'];?></strong></small></h3>
                </div>
            </div>
            <div class="row-fluid">
                <div class="span12" style="padding-top:0">
					...
					?>
							<div class="box" style=" position:relative;padding:0px 0px 5px 2px; margin-top:-10px; margin-bottom:10px;">
								...
								<div class="box-content" style="background:#f8f8f8;padding-left:50px;margin-bottom:5px">
							 	<div style="font-size:x-large"><?php echo $indikator[$indikator_aktif]['kategori'];?> : <?php echo number_format(doubleval($v[$indikator_aktif]),0,0,".");?></div>
					...
					?>
								&bull; <?php echo $iv['kategori'];?>: <?php echo number_format(doubleval($v[$iv['colom_nilai']]),0,0,".");?><br />
					 <?php
							 }}}
					 ?>
							 			</blockquote>
                                    ...
                                    <ul class="inline" style="width:500px; border-left:4px solid #ddd; padding-left:10px">
                                        <li>&bull; Jumlah Penduduk: <?php echo number_format(doubleval($plist_wilayah[0]['jumlah_penduduk']),0,0,".");?></li>
                             </ul>
                             <?php } ?>
							 	</div>
					...
					?>
                            ...
                            <div class='media-body'>
                                ...
                                <div>
                                    ...
                                    <div style="font-size:large"><?php echo $indikator[$indikator_aktif]['kategori'];?> : <?php echo number_format(doubleval($v[$indikator_aktif]),0,0,".");?></div>                      
                                </div>
                                <br />
                                    <ul class="inline indikator">
							<?php if (is_array($indikator)) { foreach($indikator as $ik=>$iv) { if ($iv['colom_nilai']!=$indikator_aktif) { ?>
                                        <li>&bull; <?php echo $iv['kategori'];?>: <?php echo number_format(doubleval($v[$iv['colom_nilai']]),0,0,".");?></li>
                            <?php }}} ?>
                                    </ul>
...
$(document).ready(function () {
	...
	,	protocol: new OpenLayers.Protocol.HTTP({
			url: 'sig/anggaran/map_json/<?php echo $kode_wilayah;?>/<?php echo $tahun;?>/<?php echo $indikator_aktif;?>',
			params:{},
