...
<link rel="stylesheet" type="text/css" href="assets/themes/bs-square/css/lat.css" media="screen">
<script src="assets/js/jquery/jquery-1.10.2.min.js"></script>
<script src="assets/themes/bs-square/js/bootstrap.min.js"></script>
<script type="text/javascript" src="assets/themes/plugin/jquery.hotkeys.js"></script>
<script type="text/javascript" src="assets/themes/plugin/bootstrap-wysiwyg.js"></script>
<script>
  ...
  <div class="navbar navbar-inverse">
      <div class="navbar-inner">
        <div class="container-fluid">
          <a class="brand pull-left" href="#">Lingkar <i class="icon-circle-blank"></i></a>
          <a class="brand2 pull-right" href="#"><i class="icon-gear"></i></a>
            ...
            <ul class="nav lat-nav pull-right">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user icon-white"></i> <?=$_SESSION['username'];?> <b class="caret"></b></a>
                <ul class="dropdown-menu">
