...
<div id="subheader">
    <div class="cmstitle">News / Add</div>
    ...
    <table>
      ...
      <tr>
        ...
        <tr>
             ...
             <tr>
              <td colspan="2"><input id="title" name="title" type="text" maxlength="150" style="width:99%" class="required" rel="Judul Berita" /></td>
          </tr>
         <tr>
              <td class="formdata_header" width="120">Image</td>
            ...
            <tr>
              <td colspan="2"><textarea name="clip" style="width:99%; height:60px" class="required" rel="Potongan Berita"></textarea></td>
          </tr>
            <tr>
              <td class="formdata_header" colspan="2">Content</td>
            </tr>
              <td colspan="2">
              <textarea name="content" style="width:370px; height:250px" class="required content" rel="Berita"></textarea>
            <br />
            <label for="publish_news"><input id="publish_news" name="status" type="checkbox" value="1" /> Publish</label>            </td>
            </tr>
        </table>        </td>
        <td width="20">&nbsp;</td>
        <td width="20">&nbsp;</td>
