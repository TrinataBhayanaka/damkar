...
if (is_array($list)) {
	?>
        ...
        <div style="margin-bottom:5px">
         ...
         <div style="font-size:large"><?php echo $indikator[$indikator_aktif]['kategori'];?> : <?php echo number_format(doubleval($v[$indikator_aktif]),0,0,".");?> <?php echo $indikator[$indikator_aktif]['satuan'];?></div>
         ...
         ?>
            <div style="width:120px; display:inline-block" title="<?php echo $alt;?>"><?php echo $iv['kategori'];?></div> <span style="margin-left:5px;border-bottom:1px dotted #999">: <strong><?php echo number_format(doubleval($v[$iv['colom_nilai']]),0,0,".");?></strong>  <?php echo $iv['satuan'];?></span><br />
         <?php
         }}}
         ?>
         </blockquote>
