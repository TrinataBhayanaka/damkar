        ...
        <div class="container">
          <div class="nav-collapse collapse navbar-responsive-collapse">
            ...
            <li>
                ...
                <button class="btn" id="button_submit"><i class="icon-save green"></i>&nbsp;Save</button>
            </li>
          </div><!-- /.nav-collapse -->
        </div>
      </div><!-- /navbar-inner -->
        ...
        <tr>
         ...
         <tr>
             ...
             <tr>
              ...
              Ya</label>
                <label for="label2" style="display:inline-block">
                  <input id="label2" name="is_headline" type="radio" value="0" checked="checked" />
                  Tidak</label></td>
          </tr>
            <tr>
            ...
            <tr>
            <td colspan="2" width="800" style="background-color:#ddd;">
            <div id="alerts"></div>
