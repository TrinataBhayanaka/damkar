...
if (is_array($list)) {
	?>
        ...
        <div style="margin-bottom:5px">
         ...
         <div style="font-size:large"><?php echo $indikator_title['nama'];?> : <?php echo number_format(doubleval($v[$indikator_aktif]),0,0,".");?> <?php echo $indikator[$indikator_aktif]['satuan'];?></div>
