	...
	?>
    BRWA.OR.ID, <br><strong><?=$nama_pemohon?></strong> telah melakukan pendaftaran Wilayah Adat secara Online dengan data sebagai berikut 
    <br><br>
	Data Pemohon:
...
<br>
    ...
    Untuk melihat dan/atau memproses data wilayah adat ini, silahkan login dihalaman BRWA ADMIN (http://brwa.or.id/brwa_admin)<br>
