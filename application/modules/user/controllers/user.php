...
class User extends Public_Controller {
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				redirect($this->input->post('pending_url')?$this->input->post('pending_url'):$this->config->item('logged_page'), 'refresh');
			}
			else
			{
	...
	function profile()
	{
		...
		$this->form_validation->set_rules('fax', $this->lang->line('create_user_validation_fax_label'), 'xss_clean');
		$this->form_validation->set_rules('tempat_lahir', 'Tempat Lahir', 'required|xss_clean');
		$this->form_validation->set_rules('tanggal_lahir', 'Tanggal Lahir', 'required|xss_clean');
		$this->form_validation->set_rules('tanda_pengenal', 'Tanda pengenal', 'required|xss_clean');
		$this->form_validation->set_rules('pekerjaan_select', 'Pekerjaan Select', 'xss_clean');
		...
		$this->data['fax'] = array(
			...
			'id'    => 'fax',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('fax', $user->fax),
		);
		$this->data['handphone'] = array(
			'name'  => 'handphone',
			'id'    => 'handphone',
