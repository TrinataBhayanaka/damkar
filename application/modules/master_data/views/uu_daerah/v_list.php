...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>UU Pembentukan Daerah<small> </small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
...
<table class="table table-hover small-font">
	<thead>
        ...
        <th style="width:200px">No UU</th>
        <th style="width:50px">Tahun UU</th>
    	...
    	<?php if(cek_array($arrData)):?>
        	<?php foreach($arrData as $x=>$val):?>
            	...
            	<tr >
                	...
                	<td valign="top"><?php echo $val["no_peraturan"]?></td>
                    <td valign="top"><?php echo $val["tahun_peraturan"]?></td>
                    <td valign="top"><?php echo $val["tentang"]?></td>
                </tr>
            <?php endforeach;?>
		<?php endif;?>
    </tbody>
