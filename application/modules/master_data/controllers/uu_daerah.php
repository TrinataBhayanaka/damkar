...
class uu_daerah extends Admin_Controller {
    ...
    function __construct(){
        ...
        $this->model=new general_model("tb_peraturan_pembentukan_daerah");
		...
		$this->module_title="UU Pembentukan Daerah";
		$this->tbl_idx="idx";
