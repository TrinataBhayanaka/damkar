    ...
    <div class="row">
        <div class="col-md-12">
          <h3 class="title"><?=$data['title'];?></h3>
           <div class="pull-left" style="color:grey; margin-top:-15px"> <?=$data['date_formatted'];?>, <?=$others[0];?></div><br />
        </div>
    </div>
        ...
        <div class="col-md-12">
		  ...
		  if (is_array($data)) {  
		  		if ($data['image']) {
					...
					$image_image .= '<span id="canvas_view"><img width="300" height="300" src="assets/image/pages/'.$data['image'].'" /></span>';
          ...
          <div class="row">
              ...
              <h3 class="sub" style="padding:2px; border-bottom:1px solid #aaa">Artikel Lain</h3>
