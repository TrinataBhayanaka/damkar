...
<ul class="breadcrumb">
        ...
        <li><a href="../admin/dms/doc_list">Document Management</a> <span class="divider">/</span></li>
        <li><a href="admin/dms/doc_view/<?=$data["id"]?>">View</a> <span class="divider">/</span></li>
        <li class="active">Check-out File: <?php echo $data["realname"]?></li>
    </ul>
</div>
