	...
	<thead>
    	<tr>
               ...
               <!-- <td>Berbatasan</td>-->
                ...
                <td style="width:300px">UU Pembentukan Daerah</td>
    ...
    <tbody>
    	<?php if(cek_array($arrData)):
        	...
        	<tr class="ttop" valign="top">
            	<td><?=$x+1?></td>
                <td><?=ucwords(strtolower($val["kabupaten_1"]))?> - Prov. <?=$val["propinsi_1"];?> berbatasan dengan:
                	<? if(cek_array($val["data_detail"])):?>
                    	<ul>
                        <? $count=1;?>
                    	<? foreach($val["data_detail"] as $xx=>$detail):?>
                        	<? foreach($detail as $dt):?>
                        	<li  style="list-style:none"><?=$count++?>. <?=ucwords(strtolower($dt["kabupaten_2"]))?>  <?=$xx!=$val["id_propinsi_1"]?" - Prov. ".$arrPropinsi[$dt["id_propinsi_2"]]:"";?></li>
                            <? endforeach;?>
						<? endforeach;?>
                        </ul>
					<? endif;?>
