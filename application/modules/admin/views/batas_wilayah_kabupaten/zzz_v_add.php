...
<div class="col-md-12 col-lg-12">
    ...
    <form id="frm" method="post" action="<?php echo $this->module;?>add/" class="form-horizontal control-label-left" role="form">
        ...
        <div class="form-group">
                ...
                <? echo form_dropdown("id_propinsi_1",$arrPropinsi1,"","id='id_propinsi_1' class='select2' style='width:100%'");?>
        ...
        <h5 class="heading"> Upload Peta </h5>
         <div class="form-group">
        	<label for="description" class="control-label no-padding-right col-md-2 ">Peta</label>
            <div class="col-md-10">
        ...
        <h5 class="heading"> Upload File Pendukung </h5>
         <div class="form-group">
        	<label for="description" class="control-label no-padding-right col-md-2 ">File</label>
            <div class="col-md-10">
...
<script>
		$(function(){
			...
			//$("#id_kabupaten_1").select2({'placeholder':"--Pilih Propinsi 1--"});
