...
<div class="row" style="margin-bottom:40px">
    ...
    <h4 class="heading">Informasi Batas Wilayah</h4>
			...
			?>
            <p class="strong">3. Kabupaten/Kota: <b><?=ucwords(strtolower($data["kabupaten_1"]))?></b> Propinsi <b><?=$data["propinsi_1"]?></b></p>
            <p class="strong">4. Berbatasan dengan :</p>
            <ol>
                <? foreach($data_detail as $x=>$val):?>
                    <li><?=ucwords(strtolower($val["kabupaten_2"]))?> <?=$val["id_propinsi_2"]!=$val["id_propinsi_1"]?"  - Propinsi ".$arrPropinsi[$val["id_propinsi_2"]]."":""?></li>
                <? endforeach;?>
            </ol>
            <p class="strong">5. UU Pembentukan Daerah </p>
            <ol>
            <? if(cek_array($data_uu)):?>
