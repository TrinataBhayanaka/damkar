...
class dashboard extends Admin_Controller {
	...
	function index(){
		...
		$data["data_rekap_peraturan"]=$this->data_rkp_peraturan();
		$data["data_rekap_segmen"]=$this->data_rkp_segmen();
		
		$data["jumlah_peraturan_propinsi"]=$this->jumlah_peraturan_propinsi;
		$data["jumlah_peraturan_kabupaten"]=$this->jumlah_peraturan_kabupaten;
		$data["jumlah_segmen_propinsi"]=$this->jumlah_segmen_propinsi;
		$data["jumlah_segmen_kabupaten"]=$this->jumlah_segmen_kabupaten;
		
		
		$data["data_rekap_peraturan_morris"]=$this->data_rkp_peraturan_morris();
	...
	function data_rkp_peraturan(){
			...
			");
			$this->jumlah_peraturan_propinsi=count($arrData1);
			//pre(count($arrData1));
			...
			$this->jumlah_peraturan_kabupaten=count($arrData2);
