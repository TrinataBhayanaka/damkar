<div class="box">
            <div class="box-header">
                <h2><i class="icon-folder-close-alt"></i>&nbsp; Latest News</h2>
                <!--<div class="box-icon">
                      ...
                      <li style="list-style:none">
                        <div class="media" style="padding-bottom:0px; margin-top:5px">
                            ...
                            <div class="pull-left" style="width:35px">
                                <img src="assets/image/news/<?=$image;?>" class="avatar media-object" alt="<?=$v['image_title'];?>" style=" width:30px;height:30px;margin:1px" />
                            </div>   
                            <div class='media-body'>
                                <!--<?=$category;?>-->
                                <div>
                                    <a href="admin/news/edit/<?=$v['idx'];?>" class="news-title"><?=$v['title'];?></a>
                                </div>
                            </div>
                         </div>
                    </li>
            ...
            <div class="content-stat" style="">
                <a href="admin/news" class="goto pull-right">View List <i class="icon-chevron-right"></i></a>
                <ul class="inline">
                    <li>
