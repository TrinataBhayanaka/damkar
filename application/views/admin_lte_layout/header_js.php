<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/style.pete.css">
...
<script>
  ...
  <script src="assets/themes/admin_lte/js/plugins/morris/morris.min.js" type="text/javascript"></script>
