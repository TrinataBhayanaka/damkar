...
<script type="text/javascript" src="/assets/js/plugins/jquery.validate/jquery.validate.addmethod.js"></script>
<script type="text/javascript" src="/assets/js/plugins/jquery.validate/jquery.validate.message_id.js"></script>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/sdk.js#xfbml=1&appId=547085488718569&version=v2.0";
...
<div class="container" style="position:relative">
	...
	<div class="row">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
        	<ul id="brwa-top" class="nav nav-pills pull-right" style="margin:2px 15px 1px">
              <li role="presentation"><a href="<?=$this->cms_cfg['fb_account']?>" class="ss ss-fb" style=""><i style="font-size:24px" class="fa fa-facebook-square"></i></a></li>
              <li role="presentation"><a href="<?=$this->cms_cfg['twitter_account']?>" class="ss ss-tw" style=""><i style="font-size:24px" class="fa fa-twitter-square"></i></a></li>
              <li role="presentation"><a href="<?=$this->cms_cfg['google']?>" class="ss ss-gg" style=""><i style="font-size:24px" class="fa fa-google-plus-square"></i></a></li>
              <li role="presentation"><a href="<?=$this->cms_cfg['youtube_account']?>" class="ss ss-yt" style=""><i style="font-size:24px" class="fa fa-youtube-square"></i></a></li>
              <li class="spacer"></li>
              <? if (!$this->ion_auth->logged_in()) { ?>
              <li role="presentation"><a href="user/register"><i class="fa fa-user"></i>&nbsp; Pengguna baru? Daftar <strong>disini</strong></a></li>
              <li class="spacer"></li>
              <li role="presentation"><a href="user"><i class="fa fa-key"></i>&nbsp; Masuk</a></li>
              <? } else { ?>
              <li title="My Profile"><a href="user/profile"><i class="fa fa-user"></i>&nbsp; Pengguna: <strong><?=$this->user_data['nama']?></strong></a></li>
              <li class="spacer"></li>
      ...
      <ul class="nav navbar-nav main-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
			  ...
			  <li><a target="_blank" href="assets/Lampiran 17.  Formulir Keberatan.docx">Formulir Keberatan <i class="fa fa-fw fa-file-text"></i></a></li>
              <li class="divider"></li>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdownx" data-hover="dropdown">PUSTAKA &nbsp;<i class="fa fa-angle-down"></i></a>
            <ul class="dropdown-menu">
              <li><a href="rujukan/">Rujukan</a></li>
