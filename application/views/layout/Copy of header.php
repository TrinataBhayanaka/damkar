	...
	<div class="row">
        <div class="col-md-4 col-sm-12 hidden-xs">
        	<div style="margin:9px 0 5px; color:#999; font-size:.9em">
        	 <label>Kontak</label>&nbsp;0251-8314210 <label>&nbsp;&bull;&nbsp;</label> brwa@brwa.or.id
            </div>
        </div>
        <div class="col-md-8 col-sm-12 col-xs-12">
        	<ul id="brwa-top" class="nav nav-pills pull-right" style="margin:2px 15px 1px">
              <li role="presentation"><a href="http://www.facebook.com/BRWA" class="ss ss-fb" style=""><i style="font-size:24px" class="fa fa-facebook-square"></i></a></li>
              <li role="presentation"><a href="http://www.twitter.com/BRWA_ID" class="ss ss-tw" style=""><i style="font-size:24px" class="fa fa-twitter-square"></i></a></li>
              <li role="presentation"><a href="http://plus.google.com/BRWA_movie" class="ss ss-gg" style=""><i style="font-size:24px" class="fa fa-google-plus-square"></i></a></li>
              <li role="presentation"><a href="http://www.youtube.com/user/BRWA_movie" class="ss ss-yt" style=""><i style="font-size:24px" class="fa fa-youtube-square"></i></a></li>
              <li class="spacer"></li>
    ...
    <div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav main-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="pages/slpp">SLPP</a></li>
              <li><a href="pages/ukp3">UKP3</a></li>
            </ul>
          </li>
