 ...
 */
$config['site_title']                 = "Badan Registrasi Wilayah Adat (BRWA)";       // Site Title, example.com
$config['admin_email']                = "brwaorid@gmail.com"; // Admin Email, admin@example.com
