...
|
*/
$config['encryption_key'] = '12344323';
...
$config['modules_locations'] = array(
		...
		APPPATH.'generate/' => '../generate/',
		APPPATH.'modules2/' => '../modules2/',
...
function __autoload($class) {  
	if(strpos($class, 'CI_') !== 0)
	{
		...
		{
			require_once(APPPATH.'core/'.strtolower($class).".php");
		}
		else
