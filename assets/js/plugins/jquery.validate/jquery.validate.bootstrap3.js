(function() {
  ...
  $.validator.setDefaults({
    ...
    highlight: function(element, errorClass, validClass) {
      ...
      return $obj.parents('div.form-group').removeClass(validClass).addClass(errorClass);
    },
    unhighlight: function(element, errorClass, validClass) {
      var $obj;
      $obj = element.type === 'radio' ? this.findByName(element.name) : $(element);
      $obj.next('span.help-block.' + errorClass).remove();
      return $obj.parents('div.form-group').removeClass(errorClass).addClass(validClass);
    },
