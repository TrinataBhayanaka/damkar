...
(function($) {
    ...
    */
    ...
    $.jqplot.MarkerRenderer.prototype.init = function(options) {
        ...
        var shopt = {fill:false, isarc:false, strokeStyle:this.color, fillStyle:this.color, fillColor:this.fillColor, lineWidth:this.lineWidth, closePath:true};
        if (this.style.indexOf('filled') != -1) {
            shopt.fill = true;
			//komeng donut style
			if (shopt.fillColor) {
				if (typeof shopt.fillColor === 'string') {
					shopt.fillStyle=shopt.fillColor;
				}
			}
			//end komeng
        }
    ...
    $.jqplot.ShapeRenderer.prototype.draw = function(ctx, points, options) {
        ...
        var opts = (options != null) ? options : {};
        var fill = (opts.fill != null) ? opts.fill : this.fill;
		var donut = (opts.donut != null) ? opts.donut : this.donut; //komeng
        var closePath = (opts.closePath != null) ? opts.closePath : this.closePath;
        var fillRect = (opts.fillRect != null) ? opts.fillRect : this.fillRect;
