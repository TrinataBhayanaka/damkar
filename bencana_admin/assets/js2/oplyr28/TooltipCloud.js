...
/**
 * Class: OpenLayers.Popup.TooltipCloud
 * 
 * Inherits from: 
 *  - <OpenLayers.Popup.Framed>
 */
OpenLayers.Popup.TooltipCloud = 
  OpenLayers.Class(OpenLayers.Popup.Framed, {
     ...
     * {Boolean} The TooltipCloud does not use an alpha image (in honor of the 
        ...
        "tr": {
            ...
            'blocks': [
                ...
                { // stem
                    ...
                    position: new OpenLayers.Pixel(-215, -685)
                }
            ]
        },
        "bl": {
    ...
    /** 
     * Constructor: OpenLayers.Popup.TooltipCloud
     * 
     * Parameters:
     * id - {String}
    ...
    initialize:function(id, lonlat, contentSize, contentHTML, anchor, closeBox, 
                        closeBoxCallback) {
        this.imageSrc = OpenLayers.Util.getImagesLocation() + 'cloud-popup-relative-kotak.png';
    ...
    CLASS_NAME: "OpenLayers.Popup.TooltipCloud"
});
