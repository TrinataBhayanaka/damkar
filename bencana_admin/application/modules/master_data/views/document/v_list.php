...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>Jenis Document <small>List</small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
    	...
    	<?php if(cek_array($arrData)):?>
        	<?php foreach($arrData as $x=>$val):?>
            	...
            	<tr >
                	...
                	<td valign="top"><?php echo $val["id_doc"]?></td>
                	<td valign="top"><?php echo $val["nama_doc"]?></td>
                    <td>
                    	<? if($val["realname"]!=""):?>
                    	<a href="<?php echo $val["path"].$val["realname"]?>"><i class="icon-download icon-white"></i> Download</a></td>
                        <? endif;?>
					 <td class="tc">
                	...
                	<td align="center" valign="top"><?php echo $val["order_num"]?></td>
                </tr>
            <?php endforeach;?>
		<?php endif;?>
    </tbody>
