...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>Kondisi Fisik <small>List</small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
        ...
        <!-- start: breadcrumbs -->
         <ul class="breadcrumb">
            ...
            <li><a href="<?=$this->folder?>/kondisi_fisik">Master Data</a> <span class="divider"></span></li>
...
<table class="table table-hover small-font">
	<thead>
         ...
         <tr>
          	...
          	<th width="20">No</th> 
		    <th >Kondisi Fisik</th>
		    <th width="30" class="tc">Up</th>
	        <th width="30" class="tc">Down</th>
    	...
    	<?php if(cek_array($arrData)):?>
        	<?php foreach($arrData as $x=>$val):?>
            	...
            	<tr >
                	...
                	<td valign="top"><a href="<?=$this->module?>edit/<?=$id?>"><?php echo $val["kondisi_fisik"]?></a></td>
                	<td class="tc">
                	...
                	<td valign="top"><?php echo $val["order_num"]?></a></td>
                </tr>
            <?php endforeach;?>
		<?php endif;?>
    </tbody>
