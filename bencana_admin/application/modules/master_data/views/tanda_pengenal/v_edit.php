    ...
    <div class="col-sm-12 col-lg-12">
        ...
        <!-- start: breadcrumbs -->
         <ul class="breadcrumb">
            ...
            <li><a href="<?=$this->folder?>/tanda_pengenal">Master Data</a> <span class="divider"></span></li>
    ...
    <div class="row">
	    <div class="col-md-9">
            <div class="row">
                <div class="col-md-8">
                    <!-- ID Hidden -->
                    <input type="hidden" id="id" name="id" style="color: red" class="form-control input-xs required" value="<?=$data['id'];?>" readonly />
                </div>
                <div class="col-md-8">
                    <label>Name</label>
                    <input type="text" id="name" name="name" class="form-control input-xs required" value="<?=$data['name'];?>" />
                </div>
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-8">
                    	 ...
                    	 <input type="text" id="kode_kab" name="description" class="form-control input-xs required" value="<?=$data['description'];?>" />
                    </div>
