    ...
    <div class="row">
	    <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8">
                    <label>Nama </label>
                    <input type="text" id="name" name="name" class="form-control input-xs required"  />
                </div>
                 <div class="col-md-8">
                    <label>Description </label>
                    <input type="text" id="description" name="description" class="form-control input-xs required"  />
                </div>
				<div class="row">
                     <div class="col-md-4">
