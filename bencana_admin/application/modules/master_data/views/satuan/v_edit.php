    ...
    <div class="col-sm-12 col-lg-12">
        ...
        <!-- start: breadcrumbs -->
         <ul class="breadcrumb">
            ...
            <li><a href="<?=$this->folder?>/satuan">Master Data</a> <span class="divider"></span></li>
	    ...
	    <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" id="id_satuan" name="id_satuan" class="form-control input-xs required" value="<?=$data['id_satuan'];?>" />
                </div>
                 <div class="col-md-8">
                    <label>Satuan</label>
                    <input type="text" id="satuan" name="satuan" class="form-control input-xs required" value="<?=$data['satuan'];?>" />
                </div>
