...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1> Jenis Ekosistem <small>List </small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
...
<table class="table table-hover small-font">
	<thead>
         ...
         <tr>
          	<th width="80"></th>          		
          	<th width="20">No</th> 
		    <th width="300">ID Jenis Ekosistem</th>
    	...
    	<?php if(cek_array($arrData)):?>
        	<?php foreach($arrData as $x=>$val):?>
            	...
            	<tr >
                	...
                	<td valign="top"><a href="<?=$this->module?>edit/<?=$id?>"><?php echo $val["id_jenis_ekosistem"]?></a></td>
                	<td valign="top"><?php echo $val["jenis_ekosistem"]?></td>
                	 <td class="tc">
                	...
                	<td valign="top"><?php echo $val["order_num"]?></td>
                </tr>
            <?php endforeach;?>
		<?php endif;?>
    </tbody>
...
<span class="pull-right">
	...
	<span class="paging"><?php echo $page_link; ?></span>
    </div>
</span>
