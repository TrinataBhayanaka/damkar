	    ...
	    <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" id="id_jenis_ekosistem" name="id_jenis_ekosistem" class="form-control input-xs required"  />
                </div>
                 <div class="col-md-8">
                    <label>Jenis Ekosistem </label>
                    <input type="text" id="jenis_ekosistem" name="jenis_ekosistem" class="form-control input-xs required"  />
                </div>
            </div>
            <div class="">
                <div class="row">
