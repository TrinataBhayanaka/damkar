    ...
    <div class="row">
	    <div class="col-md-9">
            <div class="row">
                ...
                <div class="col-md-8">
                    <label>Entitas</label>
                    <input type="text" id="entitas" name="entitas" class="form-control input-xs required" value="<?=$data['name'];?>" />
                </div>
                <div class="col-md-8">
                    <label>Description</label>
                    <input type="text" id="description" name="description" class="form-control input-xs required" value="<?=$data['description'];?>" />
                </div>
