...
class potensi_hayati extends Admin_Controller {
    ...
    function __construct(){
		...
		$class = __CLASS__; //potensi_hayati
		$this->class=$class;
        ...
        $this->model=new general_model("m_wa_potensi_hayati");
		...
		$this->module_title="Potensi Hayati";
		$this->tbl_idx="idx";
	 ...
	 function add(){
        ...
        if($act=="create"):
			$data=get_post();
			$entitas=$data["id_potensi_hayati"];
			$entitas1=$data["nama_potensi_hayati"];
			$datam["id_potensi_hayati"]=$entitas;;
			$datam["nama_potensi_hayati"]=$entitas1;
