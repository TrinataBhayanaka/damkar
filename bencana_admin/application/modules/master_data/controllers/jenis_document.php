...
class jenis_document extends Admin_Controller {
    ...
    function __construct(){
        ...
        $this->model=new general_model("m_wa_jenis_document");
		$this->load->model("jenis_dokumen_model");
        $this->jenis_dokumen_model=new jenis_dokumen_model();
		$this->main_layout="admin_lte_layout/main_layout";
		$this->module_title="Jenis Document";
		$this->tbl_idx="idx";
	...
	function up($id){
        ...
        $current=0;
        $arrData=$this->jenis_dokumen_model->category_search_record_where(false," order by order_num");
        ...
        $this->conn->AutoExecute($this->jenis_dokumen_model->tbl_jenis_dokumen,$data,"UPDATE","idx=".$idBefore);
        $data["order_num"]=$current;
        $this->conn->AutoExecute($this->jenis_dokumen_model->tbl_jenis_dokumen,$data,"UPDATE","idx=".$idCurrent);
    ...
    function down($id){
        ...
        $this->conn->StartTrans();
        $data["order_num"]=$current+1;
        $this->conn->AutoExecute($this->jenis_dokumen_model->tbl_jenis_dokumen,$data,"UPDATE","idx=".$idNext);
	 ...
	 function add(){
        ...
        if($act=="create"):
			...
			$data["order_num"]=$data["order_num"]?$data["order_num"]:$this->conn->GetOne("select max(order_num)+1 from ".$this->jenis_dokumen_model->tbl_jenis_dokumen);
