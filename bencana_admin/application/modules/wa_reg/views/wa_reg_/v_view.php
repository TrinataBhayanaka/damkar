...
<div class="row">
	...
	<li class="active"><a href="#view2" data-toggle="tab"><i class="icon-search"></i> Data</a></li>
...
<div id="myTabContent" class="tab-content">
   <div class="tab-pane fade" id="view1">
    ...
    <table class="table table-condensed table-bordered">
    	<tr>
    	  <td class="strong">Nama Komunitas</td><td>:</td><td><?=$data["nama_kewilayahan"]?></td></tr>
    ...
    <table class="table table-condensed table-bordered">
    	<tr><td class="strong">Nama Satuan Wilayah Adadt</td><td>:</td><td><?=$data["satuan"]?></td></tr>
...
<!--<h5 class="heading">Kontak</h5>-->
   ...
   <div class="tab-pane fade in active" id="view2">
      <div class="row">
            <div class="col-md-12">
            <?=$data_view2;?>
            <? //$this->load->view("v_view2");?>
            </div>
        </div>
   </div><!-- tab2-->
