          ...
          <div class="row">
          		<div class="col-md-6">
                	<div class="row">
                        ...
                        <div class="col-md-6">
                        	 <?php 	
                                $arrLookupGroup=m_lookup("wa_satuan","id_satuan","satuan",""," order by order_num asc "); 												$arrLookupGroup=array(""=>"-- Pilih Kondisi --")+$arrLookupGroup;
                            ?>
                            <div class="form-group">
                            <label>Satuan<i class="fa fa-question-circle frmtip" title="<?=$tooltip['4_c']?>"></i></label>
                            <?=form_dropdown("satuan",$arrLookupGroup,false,"id='satuan' class='form-control'");?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-2">
                	<div class="row">
                        <div class="col-md-12">
                            ...
                            <?php 	
                                $kfisik=m_lookup("wa_kondisi_fisik","idx","kondisi_fisik",""," order by order_num asc "); 												$arrLookupGroup=array(""=>"-- Pilih Kondisi --")+$arrLookupGroup;
                            	foreach($kfisik as $k=>$v) {
							?>
                            <div class="radio">
                              <label>
                                <input name="id_kondisi_fisik" type="radio" value="<?=$k;?>">
                                <?=$v;?>
                              </label>
                            </div>
                            <? } ?>
          ...
          <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                            <label>Tujuan & fungsi para pemangku adat<i class="fa fa-question-circle frmtip" title="<?=$tooltip['8_c']?>"></i></label>
                ...
                <div class="col-md-6">
                	...
                	<div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea name="contoh_keputusan" class="form-control" rows="7"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
									...
									?>
                                    <tr>
                                        <td><?=$v?><input type="hidden" class="form-control" value="<?php echo $k;?>" name="id_potensi[]"><input type="hidden" class="form-control" value="<?php echo $v?>" name="potensi[]"></td>
                ...
                <div class="col-md-12">
                	<!--Confirm-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                <label>Lampiran file Peta</label>
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                    <!--Penanda Tangan Kontrak -->
                        <div class="row">
                            <div class="col-md-12">
                                <h3>14. Penanda Tangan Kontrak<i class="fa fa-question-circle frmtip" title="<?=$tooltip['14']?>"></i></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
...
$(function(){
	...
	uploader.bind('FileUploaded', function(upldr, file, object) {
		...
		if (uploader.files.length === (uploader.total.uploaded + uploader.total.failed) && uppeta.files.length === (uppeta.total.uploaded + uppeta.total.failed)) {
			x=true;
			$('#fdata').submit();
		}
	});
	uploader.bind('UploadProgress', function(up, file) {
		...
		var col="blue";
		$(".plupload_progress_bar").attr("style", "width:"+ file.percent + "px; height:10px; float:left; margin-top:5px; background:"+col+"; display:inline-block");
		$(".plupload_progress_text").text(file.percent + "%");
	...
	uppeta.bind('FileUploaded', function(upldr, file, object) {
		...
		if (uppeta.files.length === (uppeta.total.uploaded + uppeta.total.failed) && uploader.files.length === (uploader.total.uploaded + uploader.total.failed)) {
			y=true;
			$('#fdata').submit();
		}
	});
	...
	$('#fdata').submit(function(e) {
		...
		if (uploader.files.length > 0 || uppeta.files.length > 0) {
			uploader.start();
			uppeta.start();
		}
		else {
