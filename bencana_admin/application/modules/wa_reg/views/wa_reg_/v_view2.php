...
<div id="print_this">
  ...
  <p align="center">No. <input type="text" name="no_urut_f021" size="10" value="<?=$data["no_urut_f021"];?>" > /BRWA-F021</p>	
  <div class="col-md-12"> 
	<table border="1" cellspacing="0" cellpadding="4" width="100%">
	  <tr align="center" style="background-color:#478fca;color:white;border-collapse: collapse;">
