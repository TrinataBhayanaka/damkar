...
<div class="col-md-12 col-lg-12">
    ...
    <div class="row-fluid">
		...
		<?php echo form_open("wa_reg/wa_reg_/edit/$id",'id="frm"');?>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<?php echo form_input('pos_x',$data["pos_x"],'id="koordinat_lintang" class="form-control required"');?>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									<label>Longitude</label>
									<?php echo form_input('pos_y',$data["pos_y"],'id="koordinat_bujur" class="form-control required"');?>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-6">
                                    ...
                                    <textarea name="struktur" class="form-control required" rows="2"><?=$data["struktur"]?></textarea>
...
<script>
	...
	$(function(){
		...
		var uploader3 = new plupload.Uploader({
		  browse_button: $(".browse_doc").eq(0).attr("id"), // this can be an id of a DOM element or the DOM element itself
		  url: '<?=base_url()?>upload/all/',
		  flash_swf_url : 'http://rawgithub.com/moxiecode/moxie/master/bin/flash/Moxie.cdn.swf',
		  file_data_name:'userfile'
		});
		...
		$(".browse_doc").each(function(){
			//alert($(this).attr("id"));
			uploader3.settings.browse_button = $(this).attr('id');
			uploader3.init();
		});
		
		$('.browse_doc').click(function()
		{
			//alert("test");
		...
		*/
		$(".browse_doc_upload").click(function(e){
			e.preventDefault();
			uploader3.start();
		});
