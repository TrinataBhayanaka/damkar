...
class wa_reg_ extends Admin_Controller {
    ...
    function __construct(){
		...
		$this->model_wa_data_h=new general_model("wa_data_history");
		
		$this->model_contact=new general_model("wa_contact");
		$this->model_contact_h=new general_model("wa_contact_history");
		
		$this->model_hukum_adat=new general_model("wa_hukum_adat");
		$this->model_hukum_adat_h=new general_model("wa_hukum_adat_history");
		
		$this->model_hayati=new general_model("wa_hayati");
		$this->model_hayati_h=new general_model("wa_hayati_history");
		
		$this->model_hak_atas_tanah=new general_model("wa_hak_atas_tanah");
		$this->model_hak_atas_tanah_h=new general_model("wa_hak_atas_tanah_history");
		
		$this->model_sejarah=new general_model("wa_sejarah");
		$this->model_sejarah_h=new general_model("wa_sejarah_history");
		
		$this->model_lembaga_adat=new general_model("wa_lembaga_adat");
		$this->model_lembaga_adat_h=new general_model("wa_lembaga_adat_history");
		
		$this->model_potensi_hayati=new general_model("wa_potensi_hayati");
		$this->model_potensi_hayati_h=new general_model("wa_potensi_hayati_history");
		
		$this->model_potensi_hayati_lain=new general_model("wa_potensi_hayati_lain");
		//$this->model_potensi_hayati_lain_h=new general_model("wa_potensi_hayati_lain_history");
		
		$this->model_file_peta=new general_model("wa_register_file_peta");
		$this->model_file_peta_h=new general_model("wa_register_file_peta_history");
		
		$this->model_file=new general_model("wa_register_file");
		$this->model_file=new general_model("wa_register_file_history");
		
		$this->model_image=new general_model("wa_register_image");
		$this->model_image_h=new general_model("wa_register_image_history");
		
		$this->model_batas_wilayah=new general_model("wa_batas_wilayah");
		//$this->model_batas_wilayah_h=new general_model("wa_batas_wilayah_history");
		
		$this->model_pembagian_ruang=new general_model("wa_hak_pembagian_ruang");
		//$this->model_pembagian_ruang_h=new general_model("wa_hak_pembagian_ruang_history");
	...
	function add($idx=null){
        ...
        if($act=="create"):
			...
			//h
			//$this->model_wa_data_h->InsertData($data);
			$id_last_h=$this->model_wa_data_h->GetLastID("idx");
			$id_last=$this->model->GetLastID("idx");
			$data_update=$data;
			unset($data_update["idx"]);
			$data_update["id_wa"]=$id_last;
			$data_update["tanggal_revisi"]=date('Y-m-d');
			$data_update["status_data"]="I";
			pre($data_update);exit;
			
			$this->model_contact_h->DeleteData("id_wa=".$id_last_h);
			$this->model_contact_h->InsertData($data_update);
			
			$this->model_sejarah_h->DeleteData("id_wa=".$id_last_h);
			$this->model_sejarah_h->InsertData($data_update);
			
			$this->model_hukum_adat_h->DeleteData("id_wa=".$id_last_h);
			$this->model_hukum_adat_h->InsertData($data_update);
			
			$this->model_hayati_h->DeleteData("id_wa=".$id_last_h);
			$this->model_hayati_h->InsertData($data_update);
			
			$this->model_lembaga_adat_h->DeleteData("id_wa=".$id_last_h);
			$this->model_lembaga_adat_h->InsertData($data_update);
			
			$this->model_hak_atas_tanah_h->DeleteData("id_wa=".$id_last_h);
			$this->model_hak_atas_tanah_h->InsertData($data_update);
			
			$this->model_potensi_hayati_h->DeleteData("id_wa=".$id_last_h);
			if(cek_array($data_potensi)):
				foreach($data_potensi as $data_pot):
					$data_pot["id_wa"]=$id_last_h;
					$this->model_potensi_hayati_h->InsertData($data_pot);
				endforeach;	
			endif;
			
			$this->update_file($id_last_h);
			$this->update_image($id_last_h);
			$this->update_file_peta($id_last_h);
			
			
			//c
			$this->model->InsertData($data);
			$data_updates=$data;
			unset($data_updates["idx"]);
			$data_updates["id_wa"]=$id_last;
			
			$this->model_contact->DeleteData("id_wa=".$id_last);
			$this->model_contact->InsertData($data_updates);
			
			$this->model_sejarah->DeleteData("id_wa=".$id_last);
			$this->model_sejarah->InsertData($data_updates);
			
			$this->model_hukum_adat->DeleteData("id_wa=".$id_last);
			$this->model_hukum_adat->InsertData($data_updates);
			
			$this->model_hayati->DeleteData("id_wa=".$id_last);
			$this->model_hayati->InsertData($data_updates);
			
			$this->model_lembaga_adat->DeleteData("id_wa=".$id_last);
			$this->model_lembaga_adat->InsertData($data_updates);
			
			$this->model_hak_atas_tanah->DeleteData("id_wa=".$id_last);
			$this->model_hak_atas_tanah->InsertData($data_updates);
	...
	function add_bu_history($idx=null){
		if($this->encrypt_status==TRUE):
			$id_enc=$idx;
			$id=decrypt($idx);
		endif;
