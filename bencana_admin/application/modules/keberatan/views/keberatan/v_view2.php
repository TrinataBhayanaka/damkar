...
<div class="row" style="text-align:right;padding-bottom:0px;">
	<div class="col-md-12">
	<a href="#" target="_blank"class="print-pdf" data-url="" title="Data Pendaftar"><i class="fam-page_white_acrobat"></i> PDF</a>
	</div>
</div>
...
<style>
  ...
  <p align="center">No. <?=$data["no_urut_f021"];?>/BRWA-F021</p>	
  <div class="col-md-12"> 
