        ...
        <div id="print_this">
            ...
            <div class="col-xs-12">
                ...
                <a class="btn btn-app bg-purple" href="<?php echo $this->module?>add" id="addData">
                    <i class="fa fa-plus"></i> Input Galeri Album
                </a>
                ...
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Tabel Daftar Galeri Album</h3>
                      <div class="box-tools">
                        ...
                        <form name="frmMain" action="<?=$this->module.'del_cek'?>" method="post" OnSubmit="return onDelete();">
                            <table class="table table-hover table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="forder" width="300" rel="title">Title/Judul Album</th>
                                ...
                                <? if (is_array($arrDB)) { foreach($arrDB as $k=>$v) {
                                    ...
                                    $id=$this->encrypt_status==TRUE?encrypt($v['idx']):$v['idx'];
                               ...
                               ?>
                                            <tr>
                                                ...
                                                <td rel="title_col"><?=$v['namaAlbum'];?></td>
                                                <td><?=$status_badges;?></td>
                                            </tr>
                                    <? } }?>
