                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control input-xs required" placeholder="title" value="<?=$data['title'];?>" />
                                         <input type="hidden" id="category" name="category" class="" placeholder="" value="6" />
                                    </div>
                                   </div>
                            ...
                            <div class="col-md-4">
                                <!--<h3 class="heading">Options</h3>-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <!--<div id="imgcontainer">
                                                <label>Cover Album<span class="help-block" style="display:inline">(Max filesize: 500kb)</span></label>
												<img src="<?=base_url()?>assets/images/no-images.gif" style="width:80%; margin-bottom:10px;" class="img-polaroid" id="previewplay"/>
                                                </div>
                                            </div>
                                            <input id="image_name" type="hidden" name="image_name" />
											<input type="file" name="image" id="imgInpPlay" required= "required"/>-->
							...
							<!--<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-6 form-group">
										<div class="col-md-7">
                                                <label>Cover Album<span class="help-block" style="display:inline">(Max filesize: 500kb)</span></label>
												<img src="<?=base_url()?>assets/images/no-images.gif" style="width:100% " class="img-polaroid" id="previewplay"/>
										</div>
