                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control" id="album" name="album">
											...
											foreach ($album as $key => $value) {
												$selected="";
											?>
											<option value="<?=$value['idx']?>" <?=$selected?>><?=$value['title']?></option>
											<?php 
												}

											?>
										</select>	
                                         <input type="hidden" id="category" name="category" class="" placeholder="" value="7" />
                                    </div>
                                   </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="attachment_frame" class="form-group">
												<span class="help-block" style="display:inline">Upload Foto</span>
												<div id="imgcontainer">
