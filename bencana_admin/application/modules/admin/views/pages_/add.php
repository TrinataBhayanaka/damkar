    ...
    <div class="row">
	    <div class="col-md-8">
            <div class="row">
                <div class="col-md-12">
                    <label>Simpul</label>
                    <input type="text" id="simpul" name="simpul" class="form-control input-xs required" placeholder="Simpul" value="<?=$data['simpul'];?>" />
				</div>
            </div>
            <div class="row">
                    <div class="col-md-12">
                        <label>Nama Fasilitator </label>
                        <input type="text" name="nama" id="nama" cols="10" rows="3" class="form-control required"><?=$data['nama'];?></input>
                    </div>
                </div>
            <div class="row">
                <div class="col-md-12">
                	...
                	<div class="input-group">
						<input name="date" id="dp3" class="form-control timepicker" data-date-format="yyyy-mm-dd" type="text" size="10">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" name="kontak_fasilitator" id="kontak_fasilitator" cols="10" rows="3" class="form-control required"><?=$data['kontak_fasilitator'];?></input>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" name="kontak_fasilitator_2" id="kontak_fasilitator_2" cols="10" rows="3" class="form-control required"><?=$data['kontak_fasilitator_2'];?></input>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <label>Alamat BRWA</label>
                    <textarea name="alamat_brwa" id="alamat_brwa" cols="10" rows="3" class="form-control required"><?=$data['alamat_brwa'];?></textarea>
                </div>
            </div>
