    ...
    <div class="row">
	    <div class="col-md-9">
            <div class="row">
                <div class="col-md-8">
                    <label>Simpul</label>
                    <input type="text" id="simpul" name="simpul" class="form-control input-xs required" value="<?=$data['simpul'];?>" />
                </div>
                <div class="col-md-8">
                    <label>Nama</label>
                    <input type="text" name="nama" id="nama" cols="10" rows="3" class="form-control required" value="<?=$data['nama'];?>"></input>
                </div>
               	 <?
						if ($data['tanggal']) {
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="kontak_fasilitator" id="kontak_fasilitator" cols="10" rows="3" class="form-control required" value="<?=$data['kontak_fasilitator'];?>"></input>
                </div>
                <div class="col-md-8">
                   <label>Kontak HP</label>
                    <input type="text" name="kontak_fasilitator_2" id="kontak_fasilitator_2" cols="10" rows="3" class="form-control required" value="<?=$data['kontak_fasilitator_2'];?>"></input>
                </div>
                <div class="col-md-8">
                   <label>Alamat BRWA</label>
                   <textarea name="alamat_brwa" id="alamat_brwa" cols="10" rows="3" class="form-control required" ><?=$data['kontak_fasilitator_2'];?></textarea>
                </div>
