...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>Articles<small> List</small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
        ...
        <!-- start: breadcrumbs -->
         <ul class="breadcrumb">
            ...
            <li><a href="<?=base_url()?>admin/articles">Content</a> <span class="divider"></span></li>
           <li><a href="<?=base_url()?>admin/articles""><?=$this->module_title?></a> <span class="divider"></span></li>
  ...
  <? if (is_array($arrDB)) { foreach($arrDB as $k=>$v) {
   ...
   ?>
            	<tr>
					<td>
                    	<!--<div class="btn-group">
                            <a href="<?//=$url_edit;?>" class="btn"><i class="icon-edit icon-white"></i></a>
                            <a href="<?//=$url_delete;?>" class="btn"><i class="icon-trash icon-white"></i></a>
                        </div>-->
