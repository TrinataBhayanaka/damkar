...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="page-header">
            <div class="row"> 
                <div class="col-md-12">
                    <h1>Regulasi<small> List</small></h1>
                </div><!-- col -->
              </div><!-- row-->
        </div><!-- end: page-header -->
...
<div id="tabs-0">
        ...
        <th class="forder" width="300" rel="ket">Keterangan</th>
  ...
  <? if (is_array($arrDB)) { foreach($arrDB as $k=>$v) {
   ...
   ?>
            	<tr>
                    ...
                    <td rel="ket_col" width="150"><?=$v['others'];?></td>
                    <td>
                    	<?php if($v["order_num"]>1):?>
                    		<a href="<?=$this->module?>up/<?=$id?>"><i class="icon-arrow-up"></i></i>
						<? endif;?>
                    </td>
                    <td>
                    	
                    	<?php if($v["order_num"]< count($arrDB)):?>
                    		<a href="<?=$this->module?>down/<?=$id?>"><i class="icon-arrow-down"></i></a>
						<? endif;?>

                    </td>
                    <td><?=$v["order_num"]?></td>
                    <td><a target="_blank" href="<?=$this->config->item('site_url');?>assets/image/regulasi/<?=$v['image'];?>">Download</a></td>
                    <td><?=$status_badges;?></td>
					<!--<td>
        ...
        <div class="row tables_info">
            <div class="col-md-8">
                <div class="row">
                    <!--<div class="col-md-12">
                        <div class="displaying">Displaying : <?php //$data_start;?> - <?php //$data_end;?> of <?php //$total_rows;?> entries,</div>
