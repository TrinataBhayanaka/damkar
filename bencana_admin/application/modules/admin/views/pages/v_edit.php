    ...
    <div class="row">
	    <div class="col-md-9">
            <div class="row">
                <div class="col-md-8">
                    <label>ID</label>
                    <input type="text" id="idx" name="idx" style="color: red" class="form-control input-xs required" value="<?=$data['idx'];?>" readonly />
                </div>
                <div class="col-md-8">
                    <label>Kondisi Fisik</label>
                    <input type="text" id="kondisi_fisik" name="kondisi_fisik" class="form-control input-xs required" value="<?=$data['kondisi_fisik'];?>" />
                </div>
