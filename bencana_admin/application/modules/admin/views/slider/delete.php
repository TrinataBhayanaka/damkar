...
<div id="breadcrumbs" class="breadcrumbs-fixed">
    ...
    <li><a href="admin/slider">Image Slider</a> <span class="divider">\</span></li>
...
<div class="page-header">
	<h1>Image Slider <small>&bull; Delete </small></h1>
</div>
<div class="toolbar">
    <div class="pull-left">
        <div class="btn-group">
            <a href="javascript:history.back()" class="btn"><i class="icon-arrow-left bc-icon"></i></a>
            <a href="admin/slider/" class="btn"><i class="icon-list bc-icon"></i> List</a>
            <a href="admin/slider/add" class="btn"><i class="icon-plus  bc-icon"></i> Add</a>
        </div>
        <div class="btn-group">
            <a href="admin/slider/edit/<?=$data['idx'];?>" class="btn"><i class="icon-edit bc-icon"></i> <i class="icon-eye-open bc-icon"></i> Edit/View</a>
        </div>
    </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                   <div class="alert alert-error">
                    <h4>Warning!</h4>
                    Delete Item with title <strong>"<?=$data['title'];?>"</strong> ??...<br /><br />
