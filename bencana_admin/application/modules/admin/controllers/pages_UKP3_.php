...
class pages_UKP3_ extends Admin_Controller {
    ...
    function __construct(){
		...
		$this->module=$this->folder."admin/pages_UKP3_/";
   ...
   function index($forder=0,$limit=5,$page=1){
   	...
   	$data_layout["content"]=$this->load->view("pages_UKP3_/list_view_UKP3",$data,true);
   ...
   function add_ukp3(){
   	...
   	$data_layout["content"]=$this->load->view("pages_UKP3_/add_ukp3",$data,true);
   	$this->load->view($this->admin_layout,$data_layout);
   }
   ...
   function edit_ukp3($idx=false){
   	...
   	$data["acc_active"]="content";
   	$data["module"]=$this->module;
   	$data_layout["content"]=$this->load->view("pages_UKP3_/edit_ukp3",$data,true);
   	$this->load->view($this->admin_layout,$data_layout);
   }
